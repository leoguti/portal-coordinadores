...
const navItems = [
  ...
  { name: "Fincas", href: "/generadores", icon: "🌿", roles: ["Coordinador", "Administrador", "Supervisor"] },
  { name: "Duplicados Fincas", href: "/generadores/duplicados", icon: "🔍", roles: ["Administrador", "Supervisor"] },
