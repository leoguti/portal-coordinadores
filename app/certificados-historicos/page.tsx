...
export default function CertificadosHistoricosCoordPage() {
    ...
    <AuthenticatedLayout>
      <div className="p-8 max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">
          Mis Certificados Históricos
        </h1>
        <p className="text-sm text-gray-500 mb-6">
          Certificados registrados bajo tu coordinación en años anteriores.
        </p>
        ...
        {!searched && (
          <p className="text-gray-500 text-sm text-center py-12">
            Busca por nombre, cédula o año para consultar el histórico.
          </p>
        )}
          ...
          <>
            <div className="mb-3">
              <p className="text-sm text-gray-600">
                <span className="font-semibold">{data.total.toLocaleString()}</span> certificados
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200 bg-gray-50 text-left">
                      ...
                      <th className="px-4 py-3 font-medium text-gray-600 text-right">Envases</th>
