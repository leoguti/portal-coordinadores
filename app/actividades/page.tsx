                                  ...
                                  <div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                                      {actividad.fields.Fotografias?.map((foto, idx) => {
                                        const thumbnailUrl = foto.thumbnails?.large?.url || foto.url;
                                        const proxiedUrl = `/api/image-proxy?url=${encodeURIComponent(thumbnailUrl)}`;
                                        const fullProxiedUrl = `/api/image-proxy?url=${encodeURIComponent(foto.url)}`;
                                        ...
                                        return (
                                          <div key={foto.id} className="relative group">
                                            <img
                                              ...
                                              onClick={() => window.open(fullProxiedUrl, '_blank')}
                                            />
