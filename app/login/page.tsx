    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#042726] flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="text-4xl font-bold text-[#00d084] mb-4">Portal CampoLimpio</h1>
          <p className="text-xl text-[#00d084] font-medium mb-6">Gestión integral de operaciones en campo</p>
